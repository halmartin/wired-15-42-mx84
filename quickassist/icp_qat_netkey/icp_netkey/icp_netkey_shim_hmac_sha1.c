...
static int icp_hmac_sha1_setkey(struct crypto_ahash *tfm,
...
static struct ahash_alg icp_hmac_sha1 = {
        ...
        .setkey = icp_hmac_sha1_setkey,
        .halg = {
                .digestsize = SHA1_DIGEST_SIZE,
                .statesize = sizeof(struct icp_netkey_hash_tfm_ctx),
                .base = {
                        .cra_name = "hmac(sha1)",
                        .cra_driver_name = "icp_qat_sha1_hmac",
                        .cra_priority = 0,
...
static int icp_hmac_sha1_driver_init(void)
{
        return crypto_register_ahash(&icp_hmac_sha1);
}

static int icp_hmac_sha1_driver_exit(void)
{
        return crypto_unregister_ahash(&icp_hmac_sha1);
}

struct icp_qat_alg_driver hmac_sha1_driver = {
        .driver_name = "icp_qat_sha1_hmac",
        .driver_init = icp_hmac_sha1_driver_init,
        .driver_exit = icp_hmac_sha1_driver_exit,
};
